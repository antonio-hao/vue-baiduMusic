...
<script>
  export default {
    ...
    created(){
      const musiclistUrl = this.HOST + "/v1/restserver/ting?method=baidu.ting.artist.getSongList&tinguid="+this.$route.params.singerid+"&limits=10&use_cluster=1&order=2"
