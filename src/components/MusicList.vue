<template>
    <div class="musiclist">
      <div class="panel hotsongs on" v-loading="fullscreenLoading">
        <ul class="list">
        ...
        <router-link tag="div"  :to="{name:'Recommend',params:{musictype:musictype}}" class="more-songs">查看该榜单&gt;</router-link>
      </div>
    </div>
</template>
